...
description = "aral 0.3.0 expands multiplatform support to the JVM, making the library usable in Kotlin/JVM, Spring Boot, and desktop projects."
...
Version **0.3.0** of [aral](/libs/aral) is out — and it brings **JVM support**.
