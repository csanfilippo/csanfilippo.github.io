...
description = "TurinPark 3.0.0 is a full rewrite with a Kotlin Multiplatform core, paving the way for an Android version."
slug = "turinpark-300-released"
authors = ["Calogero Sanfilippo"]
tags = ["swift", "kotlin-multiplatform", "apps", "release"]
externalLink = ""
+++
...
- The app uses [**aral**](/libs/aral) to parse the XML data feed
