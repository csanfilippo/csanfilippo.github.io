...
description = "swift-sgp4 3.0.0 removes the Objective-C++ wrapper in favour of a C++ interface, adding Linux and Android support alongside iOS and macOS."
...
This release introduces support for **Linux** and **Android**, expanding the library beyond Apple platforms.
