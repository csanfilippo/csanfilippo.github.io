...
## Key Features
- **Shake‑to‑discover interaction**: A tactile, gamified gesture that reveals destinations.
- **Dynamic content**: A growing list of places ensures freshness and replay value.
- **Minimalist design**: Lightweight at 11.3 MB, optimized for quick installs and smooth performance.
